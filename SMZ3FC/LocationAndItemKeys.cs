...
namespace SMZ3FC
{
    public static class LocationAndItemKeys
    {
        ...
        public static List<string> SubLocations { get; set; } = new List<string>()
        {
            "Ether Tablet",
            "Spectacle Rock",
            "Spectacle Rock Cave",
        ...
        public static List<string> Items { get; set; } = new List<string>()
        {
            ...
            "Brinstar Level 1 Keycard",
            "Brinstar Level 2 Keycard",
            "Brinstar Boss Keycard",
            "Wrecked Ship Level 1 Keycard",
            "Wrecked Ship Boss Keycard",
            "Maridia Level 1 Keycard",
            "Maridia Level 2 Keycard",
            "Maridia Boss Keycard",
            "Norfair Level 1 Keycard",
            "Norfair Level 2 Keycard",
            "Norfair Boss Keycard",
            "Lower Norfair Level 1 Keycard",
            "Lower Norfair Boss Keycard",
            //Junk
            "One Hundred Rupees",
            "Energy Tank",
            "Piece of Heart",
